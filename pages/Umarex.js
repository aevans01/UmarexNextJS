        ...
        <>
            <div className='MobileHeaderContainer'>
                <div className='SliderImgContainer mb-10'>
                    <Image className='SliderImg ' width={1000} height={500} src='/background3.jpg ' />
